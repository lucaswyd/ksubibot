...
export interface FortniteConfig {
  ...
  eid: string;
  level: number;
  battle_pass_owned: boolean;
  battle_pass_lvl: number;
  banner: string;
  add_users: boolean;
  leave_time: number;
  join_message: string;
...
export interface DiscordConfig {
  run_discord_client: boolean;
  guild_slash_status_response: string;
  command_guild: string;
  status: string;
  status_type: number;
}
...
export interface EnvConfig {
  ...
  DISCORD_BOT_OWNER: string | undefined;
}
